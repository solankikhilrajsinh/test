...
if ($post_data) {
    ...
    if (!$error) {
        ...
        if (!$error) {
            $sql = "INSERT INTO practice (name, gender, phone, dob, email, password) VALUES ('" . $post_data['name'] . "', '" . $post_data['gender'] . "', '" . $post_data['phone'] . "', '" . $post_data['dob'] . "', '" . $post_data['email'] . "', '" . $post_data['password'] . "')";
